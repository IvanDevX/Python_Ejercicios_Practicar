...
boton_punto = Button(root, text=".", width=6, height=2, bg="grey", fg="blue", font=("arial", 12, "bold"), cursor="hand2").grid(row=4, column=2, padx=1, pady=1)
boton_igual = Button(root, text="=", width=13, height=2, bg="grey", fg="blue", font=("arial", 12, "bold"), cursor="hand2").grid(row=4, column=3, columnspan=2, padx=1, pady=1)
boton_borrar_ultimo = Button(root, text="<=", width=6, height=2, bg="grey", fg="blue", font=("arial", 12, "bold"), cursor="hand2").grid(row=1, column=3, padx=1, pady=1)
boton_borrar_todo = Button(root, text="AC", width=6, height=2, bg="grey", fg="blue", font=("arial", 12, "bold"), cursor="hand2").grid(row=1, column=4, padx=1, pady=1)

# Botones Operaciones
boton_sumar = Button(root, text="+", width=6, height=2, bg="grey", fg="blue", font=("arial", 12, "bold"), cursor="hand2").grid(row=2, column=3, padx=1, pady=1)
boton_restar = Button(root, text="-", width=6, height=2, bg="grey", fg="blue", font=("arial", 12, "bold"), cursor="hand2").grid(row=2, column=4, padx=1, pady=1)
boton_dividir = Button(root, text="/", width=6, height=2, bg="grey", fg="blue", font=("arial", 12, "bold"), cursor="hand2").grid(row=3, column=3, padx=1, pady=1)
boton_multiplicar = Button(root, text="*", width=6, height=2, bg="grey", fg="blue", font=("arial", 12, "bold"), cursor="hand2").grid(row=3, column=4, padx=1, pady=1)
